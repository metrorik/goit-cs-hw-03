...
-- 3. Змініть статус конкретного завдання на 'in progress'
...
VALUES ('New Task Title', 'Task Description', (SELECT id FROM status WHERE name = 'new'), 1);
...
-- 11. Отримати завдання з певною доменною частиною електронної пошти.
SELECT tasks.*
FROM tasks
